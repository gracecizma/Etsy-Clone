    ...
    <div className="full-cart-container">
      ...
      <div className="cart-summary-container">
        <div className="cart-payment-container">
          <p className="total-text">How will you pay?</p>
          <div>
            <input type="radio" value="Credit/Debit" name="paymentMethod" />
            Credit/Debit
          </div>
          <div>
            <input type="radio" value="Monopoly Money" name="paymentMethod" />
            Monopoly Money
          </div>
          <div>
            <input type="radio" value="IOU Slip" name="paymentMethod" />
            IOU Slip
          </div>
        </div>

        <div className="cart-subtotal-container">
          <p className="total-text">Item(s) Total</p>
          <p className="total-box">${parseFloat(totalPrice).toFixed(2)}</p>
        </div>
        ...
        <div className="checkout-button-container">
          <button
            ...
            className="checkout-button form-button"
          >
            Proceed to checkout
          </button>
        </div>
